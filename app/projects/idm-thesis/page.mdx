...
<TimelineTable
	data={[
		...
		{ week: "Week 4 - Demo Prototype", activity: "AI Transcription / Image Generation" },
...
I wondered if there should be a shared canvas where artifacts can be saved to and moved around by all participants. However, this began to feel similar to tools we have today like Figma or Miro. I began to rethink how ideas should move and combine, realizing that “saving” visuals to a shared space isn't the novel part of the project.

I am more interested in how the system makes changing ideas and perspectives visible in real time, highlighting where participants align, diverge, and gradually converge. This led me to focus more on a more ephemeral experience with the spatial position of artifacts.
